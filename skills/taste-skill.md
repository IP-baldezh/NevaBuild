...
* Use Tailwind `dark:` variant OR CSS variables for tokens.
...
* **shadcn/ui customization:** NEVER in default state.

### 9.G EM-DASH BAN (the single most-violated Tell)

**Em-dash (`—`) is COMPLETELY banned.** It is the LLM's signature stylistic crutch.

* **Banned in headlines, eyebrows, labels, pills, button text, image captions, nav items.**
* **Banned in body copy.** Restructure the sentence: two sentences with a period, a comma, parentheses, or a colon.
...
- [ ] **Real images used** (no div-based fake screenshots, no hand-rolled decorative SVGs)?
